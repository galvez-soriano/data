...
* Map of Mexico
*========================================================================*
cd "C:\Users\galve\Documents\Papers\Current\English on labor outcomes\Data\Map"
shp2dta using mx_state, database(mxdb) coordinates(mxcoord) genid(id)
use "mxdb.dta", clear
sort name place
rename ref state
...
spmap ps_eng08 using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
graph export "$doc\map01.png", replace

spmap ps_eng11 using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
graph export "$doc\map02.png", replace

spmap ps_eng08r using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
graph export "$doc\map01r.png", replace

spmap ps_eng11r using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
graph export "$doc\map02r.png", replace

spmap ps_eng08u using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
graph export "$doc\map01u.png", replace

spmap ps_eng11u using "mxcoord.dta", id(id) ///
clmethod(eqint) clnumber(9) eirange(0 1)
